...
namespace wraps
{
	...
	public:
		...
		*/
		...
		void injectObject(Ogre::Entity* pEnt, const Ogre::Vector3 & _position = Ogre::Vector3::ZERO, const Ogre::Quaternion & _orientation = Ogre::Quaternion::IDENTITY, const Ogre::Vector3 & _scale = Ogre::Vector3::UNIT_SCALE);
